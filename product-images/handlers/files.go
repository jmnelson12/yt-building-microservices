...
import (
	...
	"github.com/jmnelson12/building-microservices/product-images/files"
)
...
// UploadMultiPart uploads a file from muli part request i.e. form post
func (f *Files) UploadMultiPart(rw http.ResponseWriter, r *http.Request) {
	...
	// get id from input shown in video
